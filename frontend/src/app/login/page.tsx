  ...
  return (
    <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <form onSubmit={handleSubmit} style={{ background: '#fff', borderRadius: 16, boxShadow: '0 4px 24px 0 rgba(25, 118, 210, 0.10)', padding: 40, minWidth: 340, display: 'flex', flexDirection: 'column', gap: 24 }}>
        <h2 style={{ fontSize: 28, fontWeight: 800, color: '#1976d2', textAlign: 'center', marginBottom: 8 }}>User Login</h2>
        ...
        <div style={{ color: '#888', fontSize: 14, textAlign: 'center', marginTop: 8 }}>Demo: user@example.com / user123</div>
      </form>
    </div>
  );
}
